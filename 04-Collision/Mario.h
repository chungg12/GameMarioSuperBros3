...
#define MARIO_ANI_RACOON_IDLE_RIGHT		4
#define MARIO_ANI_RACOON_IDLE_LEFT			5
...
#define MARIO_ANI_RACOON_WALKING_RIGHT		10
#define MARIO_ANI_RACOON_WALKING_LEFT		11
...
public: 
	CMario(int objectId) : CGameObject( objectId)
	{
