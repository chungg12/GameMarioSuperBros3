...
#define OBJECT_TYPE_VENUS_PIRANHA_PLANT 15
#pragma region MARIO 
...
#define ID_SPRITE_VENUS_PIRANHA 50000
#define ID_SPRITE_VENUS_PIRANHA_DOWN_LEFT (ID_SPRITE_VENUS_PIRANHA + 1000)
#define ID_SPRITE_VENUS_PIRANHA_UP_LEFT (ID_SPRITE_VENUS_PIRANHA + 2000)
#define	ID_SPRITE_VENUS_PIRANHA_SHOOTING_DOWN_LEFT (ID_SPRITE_VENUS_PIRANHA + 3000)
#define	ID_SPRITE_VENUS_PIRANHA_SHOOTING_UP_LEFT (ID_SPRITE_VENUS_PIRANHA + 4000)
#define	ID_SPRITE_VENUS_PIRANHA_DOWN_RIGHT (ID_SPRITE_VENUS_PIRANHA + 5000)
#define ID_SPRITE_VENUS_PIRANHA_UP_RIGHT (ID_SPRITE_VENUS_PIRANHA + 6000)

#define	ID_SPRITE_VENUS_PIRANHA_SHOOTING_DOWN_RIGHT (ID_SPRITE_VENUS_PIRANHA + 7000)
#define	ID_SPRITE_VENUS_PIRANHA_SHOOTING_UP_RIGHT (ID_SPRITE_VENUS_PIRANHA + 8000)

#define ID_SPRITE_BULLET_PLANT 51000